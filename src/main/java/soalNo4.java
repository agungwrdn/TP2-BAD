 ...
 * @author rahardian
 */
public class soalNo4 extends javax.swing.JFrame {

    /**
     * Creates new form soalNo4
     */
    public soalNo4() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(soalNo4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
